package com.q1expressionpatternmatches;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Write your paragraph here");
		
//		String paragraph = scanner.nextLine();
		String paragraph= "Java is a high-level, class-based, object-oriented programming language that is designed to have\r\n"
				+ "\r\n"
...
//		scanner.nextLine();
		...
		System.out.println("The no. of sequence is: "+count);
	}
